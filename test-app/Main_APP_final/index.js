...
const encryptData = (data, key) => {
  ...
  return {
    iv: iv.toString('hex'), // Convert IV to a hex string for storage or transmission
...
const secretKey = crypto.randomBytes(32);  // Replace with your own secret key
  ...
  const decryptedData = decryptData(encryptedData.encryptedData, secretKey, encryptedData.iv);

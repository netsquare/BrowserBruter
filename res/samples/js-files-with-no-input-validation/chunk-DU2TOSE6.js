...
function AddOrganizationComponent_div_80_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = i02.\u0275\u0275nextContext();
    i02.\u0275\u0275advance();
    i02.\u0275\u0275property("ngIf", ctx_r1.validateForm == null ? null : (tmp_2_0 = ctx_r1.validateForm.get("countryList")) == null ? null : tmp_2_0.errors == null ? null : tmp_2_0.errors["required"]);
  }
}
function AddOrganizationComponent_div_86_div_1_Template(rf, ctx) {
  if (rf & 1) {
    i02.\u0275\u0275elementStart(0, "div");
    i02.\u0275\u0275text(1, "Please enter designation! ");
    i02.\u0275\u0275elementEnd();
...
function AddOrganizationComponent_div_86_Template(rf, ctx) {
  if (rf & 1) {
    i02.\u0275\u0275elementStart(0, "div", 25);
    i02.\u0275\u0275template(1, AddOrganizationComponent_div_86_div_1_Template, 2, 0, "div", 22);
    i02.\u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = i02.\u0275\u0275nextContext();
    i02.\u0275\u0275advance();
    i02.\u0275\u0275property("ngIf", ctx_r1.validateForm == null ? null : (tmp_2_0 = ctx_r1.validateForm.get("industrySectorList")) == null ? null : tmp_2_0.errors == null ? null : tmp_2_0.errors["required"]);
  }
}
function AddOrganizationComponent_div_92_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = i02.\u0275\u0275getCurrentView();
    i02.\u0275\u0275elementStart(0, "div")(1, "div", 20)(2, "label", 43);
    i02.\u0275\u0275text(3, "Template upload");
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275element(4, "br");
    i02.\u0275\u0275elementStart(5, "div", 44)(6, "input", 45);
    i02.\u0275\u0275listener("change", function AddOrganizationComponent_div_92_Template_input_change_6_listener($event) {
      i02.\u0275\u0275restoreView(_r3);
      const ctx_r1 = i02.\u0275\u0275nextContext();
      return i02.\u0275\u0275resetView(ctx_r1.onRadioChange($event));
    });
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(7, "label", 46);
    i02.\u0275\u0275text(8, "New");
    i02.\u0275\u0275elementEnd()();
    i02.\u0275\u0275elementStart(9, "div", 44)(10, "input", 47);
    i02.\u0275\u0275listener("change", function AddOrganizationComponent_div_92_Template_input_change_10_listener($event) {
      i02.\u0275\u0275restoreView(_r3);
      const ctx_r1 = i02.\u0275\u0275nextContext();
      return i02.\u0275\u0275resetView(ctx_r1.onRadioChange($event));
    });
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(11, "label", 48);
    i02.\u0275\u0275text(12, "Reval");
    i02.\u0275\u0275elementEnd()();
    i02.\u0275\u0275elementStart(13, "input", 49);
    i02.\u0275\u0275listener("change", function AddOrganizationComponent_div_92_Template_input_change_13_listener($event) {
      i02.\u0275\u0275restoreView(_r3);
      const ctx_r1 = i02.\u0275\u0275nextContext();
      return i02.\u0275\u0275resetView(ctx_r1.onFileChange($event));
    });
    i02.\u0275\u0275elementEnd()();
    i02.\u0275\u0275elementStart(14, "a", 50);
    i02.\u0275\u0275text(15, " Existing Report Template ");
    i02.\u0275\u0275elementStart(16, "span", 51);
    i02.\u0275\u0275listener("click", function AddOrganizationComponent_div_92_Template_span_click_16_listener() {
      i02.\u0275\u0275restoreView(_r3);
      const ctx_r1 = i02.\u0275\u0275nextContext();
      const basicModal_r4 = i02.\u0275\u0275reference(94);
      return i02.\u0275\u0275resetView(ctx_r1.openBasicModal(basicModal_r4));
    });
...
function AddOrganizationComponent_ng_template_93_tr_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = i02.\u0275\u0275getCurrentView();
    i02.\u0275\u0275elementStart(0, "tr")(1, "td", 65);
    i02.\u0275\u0275text(2);
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(3, "td", 65);
    i02.\u0275\u0275text(4);
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(5, "td");
    i02.\u0275\u0275text(6);
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(7, "td", 66)(8, "a", 67);
    i02.\u0275\u0275listener("nzOnConfirm", function AddOrganizationComponent_ng_template_93_tr_18_Template_a_nzOnConfirm_8_listener() {
      const item_r8 = i02.\u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = i02.\u0275\u0275nextContext(2);
      return i02.\u0275\u0275resetView(ctx_r1.deleteFile(item_r8._id));
    });
    i02.\u0275\u0275elementStart(9, "button", 68);
    i02.\u0275\u0275element(10, "span", 69);
    i02.\u0275\u0275elementEnd()();
    i02.\u0275\u0275text(11, " \xA0 ");
    i02.\u0275\u0275elementStart(12, "button", 70);
    i02.\u0275\u0275listener("click", function AddOrganizationComponent_ng_template_93_tr_18_Template_button_click_12_listener() {
      const item_r8 = i02.\u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = i02.\u0275\u0275nextContext(2);
      return i02.\u0275\u0275resetView(ctx_r1.getFileExtensionFromBase64(item_r8.reportTemplateFile, item_r8.reportTemplateName));
    });
    i02.\u0275\u0275element(13, "span", 71);
    i02.\u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    i02.\u0275\u0275advance(2);
    i02.\u0275\u0275textInterpolate(i_r9 + 1);
    i02.\u0275\u0275advance(2);
    i02.\u0275\u0275textInterpolate(item_r8.fileNameWithoutExtension);
    i02.\u0275\u0275advance(2);
    i02.\u0275\u0275textInterpolate(item_r8.fileExtension);
  }
}
function AddOrganizationComponent_ng_template_93_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = i02.\u0275\u0275getCurrentView();
    i02.\u0275\u0275elementStart(0, "div", 52)(1, "h5", 53);
    i02.\u0275\u0275text(2, "Existing Template");
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(3, "button", 54);
    i02.\u0275\u0275listener("click", function AddOrganizationComponent_ng_template_93_Template_button_click_3_listener() {
      const modal_r6 = i02.\u0275\u0275restoreView(_r5).$implicit;
      return i02.\u0275\u0275resetView(modal_r6.close("by: close icon"));
    });
    i02.\u0275\u0275elementEnd()();
    i02.\u0275\u0275elementStart(4, "div", 55)(5, "div", 56)(6, "nz-table", 57)(7, "thead")(8, "tr")(9, "th", 58);
    i02.\u0275\u0275text(10, " No ");
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(11, "th", 59);
    i02.\u0275\u0275text(12, " Template Name ");
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(13, "th", 60);
    i02.\u0275\u0275text(14, " Extension ");
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(15, "th", 61);
    i02.\u0275\u0275text(16, "Action");
    i02.\u0275\u0275elementEnd()()();
    i02.\u0275\u0275elementStart(17, "tbody");
    i02.\u0275\u0275template(18, AddOrganizationComponent_ng_template_93_tr_18_Template, 14, 3, "tr", 62);
    i02.\u0275\u0275elementEnd()()()();
    i02.\u0275\u0275elementStart(19, "div", 63)(20, "button", 64);
    i02.\u0275\u0275listener("click", function AddOrganizationComponent_ng_template_93_Template_button_click_20_listener() {
      const modal_r6 = i02.\u0275\u0275restoreView(_r5).$implicit;
      return i02.\u0275\u0275resetView(modal_r6.close("by: close button"));
    });
    i02.\u0275\u0275text(21, "Close");
    i02.\u0275\u0275elementEnd()();
  }
...
_AddOrganizationComponent.\u0275cmp = /* @__PURE__ */ i02.\u0275\u0275defineComponent({ type: _AddOrganizationComponent, selectors: [["app-add-organization"]], decls: 95, vars: 15, consts: [["basicModal", ""], [1, "sticky-header"], [1, "mt-4"], [1, "d-flex", "align-items-center", "justify-content-between", "flex-wrap"], [1, "page-breadcrumb", "m-0"], [1, "breadcrumb", "mb-0"], [1, "breadcrumb-item"], ["routerLink", "/main/organizations_management/organizations_list"], ["aria-current", "page", 1, "breadcrumb-item", "active"], [1, "form-check", "form-switch", "button-container"], ["type", "checkbox", "role", "switch", "id", "flexSwitchCheckChecked", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "flexSwitchCheckChecked", 1, "form-check-label"], [1, "button-container"], [1, "btn", "btn-secondary", "btn-icon-text", "mb-2", "mb-md-0", 3, "click"], [1, "btn", "btn-primary", "btn-icon-text", "mb-2", "mb-md-0", 3, "click"], [1, "row"], [1, "col-md-12", "grid-margin", "stretch-card"], [1, "card"], [1, "card-body"], [1, "forms-sample", 3, "formGroup"], [1, "mb-3"], ["nzName", "avatar", "nzListType", "picture-card", 1, "avatar-uploader", 3, "nzChange", "nzShowUploadList", "nzBeforeUpload"], [4, "ngIf"], ["class", "w-100 h-100 rounded-circle", "alt", "Logo", 3, "src", 4, "ngIf"], ["required", "", 1, "form-label"], [1, "text-danger"], ["formControlName", "orgName", "placeholder", "Enter organization name", "id", "orgName", "required", "", 1, "form-control"], ["class", "text-danger", 4, "ngIf"], [1, "form-label"], ["formControlName", "orgShortName", "id", "orgShortName", "placeholder", "Enter organization short name", 1, "form-control"], ["formControlName", "orgDesc", "id", "orgDesc", "placeholder", "Enter organization description", "rows", "3", 1, "form-control"], [1, "col"], ["formControlName", "contactPerson", "id", "contactPerson", "placeholder", "Enter contact person", "required", "", 1, "form-control"], ["formControlName", "designation", "id", "designation", "placeholder", "Enter designation", "required", "", 1, "form-control"], ["formControlName", "emailId", "id", "emailId", "placeholder", "Enter your Email-ID", "required", "", 1, "form-control"], ["formControlName", "headQuarterLocation", "id", "headQuarterLocation", "placeholder", "Enter headquarter location", "required", "", 1, "form-control"], ["formControlName", "countryList", "id", "countryList", "placeholder", "Enter Country", "required", "", 1, "form-control"], [1, "d-flex", "align-items-center"], ["formControlName", "industrySectorList", "id", "industrySectorName", "placeholder", "Enter Country", "required", "", 1, "form-control"], ["formControlName", "regulationStandards", "id", "regulationStandards", "placeholder", "Enter regular standard", 1, "form-control"], ["nz-icon", "", 1, "upload-icon", 3, "nzType"], [1, "ant-upload-text"], ["alt", "Logo", 1, "w-100", "h-100", "rounded-circle", 3, "src"], ["for", "formFile", 1, "form-label"], [1, "form-check", "form-check-inline"], ["type", "radio", "id", "New", "value", "New", "formControlName", "reportType", 1, "form-check-input", 3, "change", "checked"], ["for", "New", 1, "form-check-label"], ["type", "radio", "id", "Reval", "value", "Reval", "formControlName", "reportType", 1, "form-check-input", 3, "change", "checked"], ["for", "Reval", 1, "form-check-label"], ["type", "file", "id", "formFile", "accept", ".docx", 1, "form-control", 3, "change"], [1, "sidebar-brand", "nobleui-logo"], [3, "click"], [1, "modal-header"], ["id", "exampleModalLabel", 1, "modal-title"], ["type", "button", "id", "btnExistingTemplate", "aria-label", "Close", 1, "btn-close", 3, "click"], [1, "modal-body"], [1, "table-responsive"], ["nzShowSizeChanger", "", 3, "nzShowPagination", "nzData", "nzLoading"], ["id", "1", "nzColumnKey", "orgName"], ["id", "2", "nzColumnKey", "TemplateName"], ["id", "3", "nzColumnKey", "headQuarterLocation"], ["id", "5", 1, "text-center"], [4, "ngFor", "ngForOf"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", "btn-sm", "m-1", 3, "click"], [1, "ellipsis"], [1, "text-center", "action"], ["nz-popconfirm", "", "nzPopconfirmTitle", "Sure to delete?", 3, "nzOnConfirm"], ["nz-button", "", "nzType", "primary", "nzShape", "circle"], ["nz-icon", "", "nzType", "delete", "nzTheme", "outline"], ["nz-button", "", "nzType", "primary", "id", "downloadTemplate", "nzShape", "circle", 3, "click"], ["nz-icon", "", "nzType", "download", "nzTheme", "outline"]], template: function AddOrganizationComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(84, "div", 37);
    i02.\u0275\u0275element(85, "input", 38);
    i02.\u0275\u0275template(86, AddOrganizationComponent_div_86_Template, 2, 1, "div", 27);
    i02.\u0275\u0275elementEnd()();
    i02.\u0275\u0275elementStart(87, "div", 20)(88, "label", 28);
    i02.\u0275\u0275text(89, "Regular Standard");
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275element(90, "input", 39);
    i02.\u0275\u0275elementEnd();
    i02.\u0275\u0275elementStart(91, "div", 20);
    i02.\u0275\u0275template(92, AddOrganizationComponent_div_92_Template, 18, 2, "div", 22);
    i02.\u0275\u0275elementEnd()()()()()();
    i02.\u0275\u0275template(93, AddOrganizationComponent_ng_template_93_Template, 22, 4, "ng-template", null, 0, i02.\u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    let tmp_8_0;
    let tmp_9_0;

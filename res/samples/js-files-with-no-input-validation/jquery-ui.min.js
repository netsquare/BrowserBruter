(
  ...
  function (e) {
    function t(t, s) {
      ...
      return 'area' === r ? (
        ...
        t.href &&
        a &&
        'map' === n.nodeName.toLowerCase() ? (o = e('img[usemap=\'#' + a + '\']') [0], !!o && i(o)) : !1
      ) : (
        /.*/.test(r) ? !t.disabled : 'a' === r ? t.href ||
        s : s
      ) &&
      i(t)
    }
    ...
    e.fn.extend({
      scrollParent: function (t) {
        ...
        a = this.parents().filter(
          function () {
            var t = e(this);
            return s &&
            'static' === t.css('position') ? !1 : n.test(t.css('overflow') + t.css('overflow-y') + t.css('overflow-x'))
          }
        ).eq(0);
        return 'fixed' !== i &&
        a.length ? a : e(this[0].ownerDocument || document)
      },
      uniqueId: function () {
        var e = 0;
        return function () {
    ...
    e.ui.plugin = {
      ...
      call: function (e, t, i, s) {
        ...
        ) for (n = 0; a.length > n; n++) e.options[a[n][0]] &&
    ...
    e.widget.extend = function (t) {
      ...
      void 0 !== s &&
      (
        t[i] = e.isPlainObject(s) ? e.isPlainObject(t[i]) ? e.widget.extend({
      ...
      e.fn[t] = function (n) {
        ...
        return a ? this.each(
          function () {
            var i,
            a = e.data(this, s);
            return 'instance' === n ? (r = a, !1) : a ? e.isFunction(a[n]) &&
            '_' !== n.charAt(0) ? (
              i = a[n].apply(a, o),
              i !== a &&
              void 0 !== i ? (r = i && i.jquery ? r.pushStack(i.get()) : i, !1) : void 0
            ) : e.error('no such method \'' + n + '\' for ' + t + ' widget instance') : e.error(
              'cannot call methods on ' + t + ' prior to initialization; ' + 'attempted to call method \'' + n + '\''
            )
          }
        ) : (
          o.length &&
          (n = e.widget.extend.apply(null, [
            n
          ].concat(o))),
          this.each(
            function () {
    ...
    e.each({
      ...
      e.Widget.prototype['_' + t] = function (s, n, a) {
        ...
        o &&
        e.effects &&
        e.effects.effect[r] ? s[t](n) : r !== t &&
        s[r] ? s[r](n.duration, n.easing, a) : s.queue(function (i) {
          e(this) [t](),
          a &&
          a.call(s[0]),
          i()
      ...
      'ui.mouse',
      {
        ...
        _mouseDown: function (t) {
          if (!d) {
            ...
            t.target.nodeName ? e(t.target).closest(this.options.cancel).length : !1;
            return s &&
            !n &&
        ...
        _mouseMove: function (t) {
          ...
          return (t.which || t.button) &&
          (this._mouseMoved = !0),
          this._mouseStarted ? (this._mouseDrag(t), t.preventDefault()) : (
            this._mouseDistanceMet(t) &&
            this._mouseDelayMet(t) &&
            (
    ...
    function () {
      ...
      e.position = {
        ...
        getScrollInfo: function (t) {
          var i = t.isWindow ||
          t.isDocument ? '' : t.element.css('overflow-x'),
          s = t.isWindow ||
          t.isDocument ? '' : t.element.css('overflow-y'),
          n = 'scroll' === i ||
          'auto' === i &&
        ...
        getWithinInfo: function (t) {
          ...
          return {
            ...
            width: s ||
            n ? i.width() : i.outerWidth(),
            height: s ||
            n ? i.height() : i.outerHeight()
          }
        }
      },
      e.fn.position = function (n) {
        ...
        e.each(
          ...
          function () {
            ...
            1 === i.length &&
            (
              i = l.test(i[0]) ? i.concat(['center']) : u.test(i[0]) ? [
                'center'
              ].concat(i) : [
                'center',
                'center'
        ...
        1 === k.length &&
        (k[1] = k[0]),
        'right' === n.at[0] ? y.left += m : 'center' === n.at[0] &&
        (y.left += m / 2),
        'bottom' === n.at[1] ? y.top += g : 'center' === n.at[1] &&
        (y.top += g / 2),
        p = t(T.at, m, g),
        y.left += p[0],
        y.top += p[1],
        this.each(
          function () {
            ...
            'right' === n.my[0] ? M.left -= d : 'center' === n.my[0] &&
            (M.left -= d / 2),
            'bottom' === n.my[1] ? M.top -= c : 'center' === n.my[1] &&
            (M.top -= c / 2),
            M.left += C[0],
            M.top += C[1],
            a ||
      ...
      e.ui.position = {
        fit: {
          left: function (e, t) {
            ...
            t.collisionWidth > a ? h > 0 &&
            0 >= l ? (i = e.left + h + t.collisionWidth - a - n, e.left += h - i) : e.left = l > 0 &&
            0 >= h ? n : h > l ? n + a - t.collisionWidth : n : h > 0 ? e.left += h : l > 0 ? e.left -= l : e.left = o(e.left - r, e.left)
          },
          top: function (e, t) {
            var i,
            s = t.within,
            ...
            t.collisionHeight > a ? h > 0 &&
            0 >= l ? (i = e.top + h + t.collisionHeight - a - n, e.top += h - i) : e.top = l > 0 &&
            0 >= h ? n : h > l ? n + a - t.collisionHeight : n : h > 0 ? e.top += h : l > 0 ? e.top -= l : e.top = o(e.top - r, e.top)
          }
        },
        flip: {
          left: function (e, t) {
    ...
    e.widget(
      ...
      e.ui.mouse,
      {
        ...
        _destroy: function () {
          return (this.helper || this.element).is('.ui-draggable-dragging') ? (this.destroyOnClear = !0, void 0) : (
        ...
        _mouseCapture: function (t) {
          ...
          this.helper ||
          i.disabled ||
          e(t.target).closest('.ui-resizable-handle').length > 0 ? !1 : (
            this.handle = this._getHandle(t),
            this.handle ? (this._blockFrames(i.iframeFix === !0 ? 'iframe' : i.iframeFix), !0) : !1
          )
        },
        _blockFrames: function (t) {
          this.iframeBlocks = this.document.find(t).map(
            function () {
              var t = e(this);
        ...
        _mouseStart: function (t) {
          ...
          this._trigger('start', t) === !1 ? (this._clear(), !1) : (
            this._cacheHelperProportions(),
            e.ui.ddmanager &&
            !i.dropBehaviour &&
        ...
        _cacheMargins: function () {
          this.margins = {
            ...
            0,
            top: parseInt(this.element.css('marginTop'), 10) ||
            0,
        ...
        _setContainment: function () {
          ...
          n.containment ? 'window' === n.containment ? (
            this.containment = [
            ...
            void 0
          ) : n.containment.constructor === Array ? (this.containment = n.containment, void 0) : (
        ...
        _convertPositionTo: function (e, t) {
          ...
          return {
            top: t.top + this.offset.relative.top * i + this.offset.parent.top * i - (
              'fixed' === this.cssPosition ? - this.offset.scroll.top : s ? 0 : this.offset.scroll.top
            ) * i,
            left: t.left + this.offset.relative.left * i + this.offset.parent.left * i - (
              'fixed' === this.cssPosition ? - this.offset.scroll.left : s ? 0 : this.offset.scroll.left
            ) * i
          }
        },
        _generatePosition: function (e, t) {
          ...
          (
            ...
            (
              ...
              n - this.offset.click.top > i[3] ? n : n - this.offset.click.top >= i[1] ? n - o.grid[1] : n + o.grid[1] : n,
              a = o.grid[0] ? this.originalPageX + Math.round((h - this.originalPageX) / o.grid[0]) * o.grid[0] : this.originalPageX,
              h = i ? a - this.offset.click.left >= i[0] ||
              a - this.offset.click.left > i[2] ? a : a - this.offset.click.left >= i[0] ? a - o.grid[0] : a + o.grid[0] : a
            ),
            'y' === o.axis &&
            (h = this.originalPageX),
            'x' === o.axis &&
            (l = this.originalPageY)
          ),
          {
    ...
    e.ui.plugin.add(
      ...
      'connectToSortable',
      {
        start: function (t, i, s) {
          ...
          s.sortables = [],
          e(s.options.connectToSortable).each(
            function () {
    ...
    e.ui.plugin.add(
      ...
      'cursor',
      {
        start: function (t, i, s) {
          ...
          a = s.options;
          n.css('cursor') &&
          (a._cursor = n.css('cursor')),
          n.css('cursor', a.cursor)
        },
        stop: function (t, i, s) {
          var n = s.options;
          n._cursor &&
          e('body').css('cursor', n._cursor)
        }
      }
    ),
    e.ui.plugin.add(
      ...
      'scroll',
      {
        ...
        drag: function (t, i, s) {
          ...
          'HTML' !== o.tagName ? (
            ...
            'x' === n.axis ||
            (
              s.overflowOffset.top + o.offsetHeight - t.pageY < n.scrollSensitivity ? o.scrollTop = a = o.scrollTop + n.scrollSpeed : t.pageY - s.overflowOffset.top < n.scrollSensitivity &&
              (o.scrollTop = a = o.scrollTop - n.scrollSpeed)
            ),
            n.axis &&
            'y' === n.axis ||
            (
              s.overflowOffset.left + o.offsetWidth - t.pageX < n.scrollSensitivity ? o.scrollLeft = a = o.scrollLeft + n.scrollSpeed : t.pageX - s.overflowOffset.left < n.scrollSensitivity &&
            ...
            'x' === n.axis ||
            (
              t.pageY - e(r).scrollTop() < n.scrollSensitivity ? a = e(r).scrollTop(e(r).scrollTop() - n.scrollSpeed) : e(window).height() - (t.pageY - e(r).scrollTop()) < n.scrollSensitivity &&
              (a = e(r).scrollTop(e(r).scrollTop() + n.scrollSpeed))
            ),
            n.axis &&
            'y' === n.axis ||
            (
              t.pageX - e(r).scrollLeft() < n.scrollSensitivity ? a = e(r).scrollLeft(e(r).scrollLeft() - n.scrollSpeed) : e(window).width() - (t.pageX - e(r).scrollLeft()) < n.scrollSensitivity &&
    ...
    e.ui.plugin.add(
      ...
      'snap',
      {
        start: function (t, i, s) {
          ...
          s.snapElements = [],
          e(
            n.snap.constructor !== String ? n.snap.items ||
    ...
    e.ui.plugin.add(
      ...
      'stack',
      {
        start: function (t, i, s) {
          ...
          o.length &&
          (
            n = parseInt(e(o[0]).css('zIndex'), 10) ||
            0,
            e(o).each(function (t) {
    ...
    e.widget(
      'ui.droppable',
      {
        ...
        _splice: function (e) {
          for (var t = 0; e.length > t; t++) e[t] === this &&
          e.splice(t, 1)
        },
        _destroy: function () {
            ...
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              ...
              (
                ...
                (
                  ...
                  a = this.element.parents(':data(ui-droppable)').filter(
                    function () {
      ...
      e.ui.mouse,
      {
        ...
        _create: function () {
          ...
          this._renderAxis = function (t) {
            ...
            t = t ||
            this.element;
            for (i in this.handles) this.handles[i].constructor === String ? this.handles[i] = this.element.children(this.handles[i]).first().show() : (this.handles[i].jquery || this.handles[i].nodeType) &&
            (
        ...
        _mouseStart: function (t) {
          ...
          a.containment &&
          (
            i += e(a.containment).scrollLeft() ||
            0,
            s += e(a.containment).scrollTop() ||
            0
          ),
          ...
          this.aspectRatio = 'number' == typeof a.aspectRatio ? a.aspectRatio : this.originalSize.width / this.originalSize.height ||
          1,
        ...
        _mouseStop: function (t) {
          ...
          (
            ...
            n = s &&
            this._hasScroll(i[0], 'left') ? 0 : u.sizeDiff.height,
            a = s ? 0 : u.sizeDiff.width,
            o = {
              width: u.helper.width() - a,
              height: u.helper.height() - n
            },
            r = parseInt(u.element.css('left'), 10) + (u.position.left - u.originalPosition.left) ||
            null,
            h = parseInt(u.element.css('top'), 10) + (u.position.top - u.originalPosition.top) ||
            null,
            l.animate ||
        ...
        _updateRatio: function (e) {
          ...
          i = this.size,
          s = this.axis;
          return this._isNumber(e.height) ? e.width = e.height * this.aspectRatio : this._isNumber(e.width) &&
        ...
        _respectSize: function (e) {
          ...
          i = this.axis,
          s = this._isNumber(e.width) &&
          t.maxWidth &&
          t.maxWidth < e.width,
          n = this._isNumber(e.height) &&
          t.maxHeight &&
          t.maxHeight < e.height,
          a = this._isNumber(e.width) &&
          t.minWidth &&
          t.minWidth > e.width,
          o = this._isNumber(e.height) &&
          t.minHeight &&
        ...
        _proportionallyResize: function () {
          if (this._proportionallyResizeElements.length) for (
            var e,
            t = 0,
            i = this.helper ||
            this.element;
          ...
          e.css({
            ...
            0,
            width: i.width() - this.outerDimensions.width ||
            0
          })
        },
    ...
    e.ui.plugin.add(
      ...
      'animate',
      {
        stop: function (t) {
          ...
          o = a &&
          i._hasScroll(n[0], 'left') ? 0 : i.sizeDiff.height,
          ...
          null,
          u = parseInt(i.element.css('top'), 10) + (i.position.top - i.originalPosition.top) ||
          null;
          i.element.animate(
            e.extend(h, u && l ? {
              top: u,
    ...
    e.ui.plugin.add(
      ...
      'grid',
      {
        resize: function () {
          ...
          g &&
          (f -= u),
          /^(se|s|e)$/.test(r) ? (i.size.width = p, i.size.height = f) : /^(ne)$/.test(r) ? (i.size.width = p, i.size.height = f, i.position.top = o.top - c) : /^(sw)$/.test(r) ? (i.size.width = p, i.size.height = f, i.position.left = o.left - d) : (
            (0 >= f - u || 0 >= p - l) &&
    ...
    e.widget(
      ...
      e.ui.mouse,
      {
          ...
          if (this.dragged = !0, !this.options.disabled) {
            ...
            this.selectees.each(
              function () {
                ...
                (
                  'touch' === n.tolerance ? l = !(i.left > r || a > i.right || i.top > h || o > i.bottom) : 'fit' === n.tolerance &&
        ...
        _mouseStop: function (t) {
          ...
          e('.ui-unselecting', this.element[0]).each(
            function () {
              var s = e.data(this, 'selectable-item');
    ...
    e.widget(
      ...
      e.ui.mouse,
      {
        ...
        _mouseCapture: function (t, i) {
          ...
          'static' === this.options.type ? !1 : (
            this._refreshItems(t),
            e(t.target).parents().each(
              function () {
            ...
            (
              ...
              n
            ) ? (this.currentItem = s, this._removeCurrentsFromItems(), !0) : !1 : !1
          )
        },
        ...
        _mouseDrag: function (t) {
          ...
          for (
            ...
            (
              this.scrollParent[0] !== this.document[0] &&
              'HTML' !== this.scrollParent[0].tagName ? (
                this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY < o.scrollSensitivity ? this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop + o.scrollSpeed : t.pageY - this.overflowOffset.top < o.scrollSensitivity &&
                (
                  this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop - o.scrollSpeed
                ),
                this.overflowOffset.left + this.scrollParent[0].offsetWidth - t.pageX < o.scrollSensitivity ? this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft + o.scrollSpeed : t.pageX - this.overflowOffset.left < o.scrollSensitivity &&
                (
                  this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft - o.scrollSpeed
                )
              ) : (
                t.pageY - this.document.scrollTop() < o.scrollSensitivity ? r = this.document.scrollTop(this.document.scrollTop() - o.scrollSpeed) : this.window.height() - (t.pageY - this.document.scrollTop()) < o.scrollSensitivity &&
                (
                  r = this.document.scrollTop(this.document.scrollTop() + o.scrollSpeed)
                ),
                t.pageX - this.document.scrollLeft() < o.scrollSensitivity ? r = this.document.scrollLeft(this.document.scrollLeft() - o.scrollSpeed) : this.window.width() - (t.pageX - this.document.scrollLeft()) < o.scrollSensitivity &&
                (
        ...
        serialize: function (t) {
          ...
          e(i).each(
            function () {
              ...
              i &&
              s.push((t.key || i[1] + '[]') + '=' + (t.key && t.expression ? i[1] : i[2]))
            }
          ),
          !s.length &&
          t.key &&
        ...
        _intersectsWith: function (e) {
          ...
          d = 'x' === this.options.axis ||
          s + l > r &&
          h > s + l,
          c = 'y' === this.options.axis ||
          t + u > a &&
          o > t + u,
          p = d &&
          c;
          ...
          'pointer' !== this.options.tolerance &&
          this.helperProportions[this.floating ? 'width' : 'height'] > e[this.floating ? 'width' : 'height'] ? p : t + this.helperProportions.width / 2 > a &&
        ...
        refreshPositions: function (t) {
          ...
          this._isFloating(this.items[0].item) : !1,
          this.offsetParent &&
          this.helper &&
          (this.offset.parent = this._getParentOffset());
          var i,
          ...
          (
            ...
            t ||
            (s.width = n.outerWidth(), s.height = n.outerHeight()),
            a = n.offset(),
            s.left = a.left,
            s.top = a.top
          );
          ...
          (
            ...
            s.placeholder = {
              element: function () {
                ...
                return 'tbody' === s ? t._createTrPlaceholder(
                  t.currentItem.find('tr').eq(0),
                  e('<tr>', t.document[0]).appendTo(n)
                ) : 'tr' === s ? t._createTrPlaceholder(t.currentItem, n) : 'img' === s &&
        ...
        _contactContainers: function (t) {
          ...
          c = null,
          p = null;
          for (i = this.containers.length - 1; i >= 0; i--) if (
            !e.contains(this.currentItem[0], this.containers[i].element[0])
          ...
          if (c) if (1 === this.containers.length) this.containers[p].containerCache.over ||
          (
            ...
            if (this.currentContainer === this.containers[p]) return this.currentContainer.containerCache.over ||
            (
        ...
        _setContainment: function () {
          ...
          (
            this.containment = [
              ...
              (
                'document' === n.containment ? this.document.width() : this.window.height() ||
        ...
        _convertPositionTo: function (t, i) {
          ...
          this.scrollParent[0] !== this.document[0] &&
          e.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent,
          a = /(html|body)/i.test(n[0].tagName);
          return {
            top: i.top + this.offset.relative.top * s + this.offset.parent.top * s - (
              'fixed' === this.cssPosition ? - this.scrollParent.scrollTop() : a ? 0 : n.scrollTop()
            ) * s,
            left: i.left + this.offset.relative.left * s + this.offset.parent.left * s - (
              'fixed' === this.cssPosition ? - this.scrollParent.scrollLeft() : a ? 0 : n.scrollLeft()
            ) * s
          }
        },
        _generatePosition: function (t) {
          ...
          (
            ...
            (
              ...
              o = this.containment ? i - this.offset.click.top >= this.containment[1] &&
              i - this.offset.click.top <= this.containment[3] ? i : i - this.offset.click.top >= this.containment[1] ? i - n.grid[1] : i + n.grid[1] : i,
              s = this.originalPageX + Math.round((a - this.originalPageX) / n.grid[0]) * n.grid[0],
              a = this.containment ? s - this.offset.click.left >= this.containment[0] &&
              s - this.offset.click.left <= this.containment[2] ? s : s - this.offset.click.left >= this.containment[0] ? s - n.grid[0] : s + n.grid[0] : s
            )
          ),
          {
        ...
        _clear: function (e, t) {
          ...
          n.push(i('deactivate', this, this.containers[s])),
    ...
    e.widget(
      'ui.accordion',
      {
        ...
        _destroy: function () {
          ...
          ).removeAttr('role').removeAttr('aria-expanded').removeAttr('aria-selected').removeAttr('aria-controls').removeAttr('tabIndex').removeUniqueId(),
          this._destroyIcons(),
          e = this.headers.next().removeClass(
        ...
        _setOption: function (e, t) {
          return 'active' === e ? (this._activate(t), void 0) : (
            'event' === e &&
            (
              this.options.event &&
        ...
        refresh: function () {
          ...
          t.active === !1 &&
          t.collapsible === !0 ||
          !this.headers.length ? (t.active = !1, this.active = e()) : t.active === !1 ? this._activate(0) : this.active.length &&
          !e.contains(this.element[0], this.active[0]) ? this.headers.length === this.headers.find('.ui-state-disabled').length ? (t.active = !1, this.active = e()) : this._activate(Math.max(0, t.active - 1)) : t.active = this.headers.index(this.active),
          this._destroyIcons(),
          this._refresh()
        },
          ...
          t.length ? e.length ? (
            ...
            e.hide().animate(
              this.showProps,
              {
                ...
                step: function (e, i) {
                  i.now = Math.round(e),
                  'height' !== i.prop ? 'content-box' === h &&
                  (r += i.now) : 'content' !== o.options.heightStyle &&
    ...
    e.widget(
      'ui.menu',
      {
          ...
          this._on({
            ...
            'click .ui-menu-item': function (t) {
              ...
              (
                ...
                (this.mouseHandled = !0),
                i.has('.ui-menu').length ? this.expand(t) : !this.element.is(':focus') &&
        ...
        _destroy: function () {
          ...
          this.element.find('.ui-menu-item').removeClass('ui-menu-item').removeAttr('role').removeAttr('aria-disabled').removeUniqueId().removeClass('ui-state-hover').removeAttr('tabIndex').removeAttr('role').removeAttr('aria-haspopup').children().each(
            function () {
              var t = e(this);
              t.data('ui-menu-submenu-carat') &&
              t.remove()
            }
          ),
        ...
        _keydown: function (t) {
          ...
          switch (t.keyCode) {
            ...
            default:
              ...
              i = a &&
              - 1 !== i.index(this.active.next()) ? this.active.nextAll('.ui-menu-item') : i,
              i.length ||
              (n = String.fromCharCode(t.keyCode), i = this._filterMenuItems(n)),
              i.length ? (
                this.focus(t, i),
        ...
        focus: function (e, t) {
          ...
          e &&
          'keydown' === e.type ? this._close() : this.timer = this._delay(function () {
            this._close()
          }, this.delay),
        ...
        _scrollIntoView: function (t) {
          ...
          this._hasScroll() &&
          (
            i = parseFloat(e.css(this.activeMenu[0], 'borderTopWidth')) ||
            0,
            s = parseFloat(e.css(this.activeMenu[0], 'paddingTop')) ||
            0,
            n = t.offset().top - this.activeMenu.offset().top - i - s,
            a = this.activeMenu.scrollTop(),
            o = this.activeMenu.height(),
            r = t.outerHeight(),
            0 > n ? this.activeMenu.scrollTop(a + n) : n + r > o &&
        ...
        _move: function (e, t, i) {
          ...
          (
            s = 'first' === e ||
            'last' === e ? this.active['first' === e ? 'prevAll' : 'nextAll']('.ui-menu-item').eq( - 1) : this.active[e + 'All']('.ui-menu-item').eq(0)
          ),
          s &&
          s.length &&
          this.active ||
        ...
        select: function (t) {
          ...
          e(t.target).closest('.ui-menu-item');
          var i = {
            item: this.active
          };
        ...
        _filterMenuItems: function (t) {
         ...
         // s = RegExp('^' + i, 'i');
          return this.activeMenu.find(this.options.items).filter('.ui-menu-item').filter(function () {
            return /.*/.test(e.trim(e(this).text()))
          })
        }
      }
    ),
    e.widget(
      'ui.autocomplete',
      {
        ...
        _create: function () {
          ...
          this.valueMethod = this.element[a ||
          o ? 'val' : 'text'],
          this.isNewMenu = !0,
        ...
        __response: function (e) {
          ...
          e &&
          e.length &&
          !this.cancelSearch ? (this._suggest(e), this._trigger('open')) : this._close()
        },
        close: function (e) {
          this.cancelSearch = !0,
          this._close(e)
    ...
    e.widget(
      ...
      e.ui.autocomplete,
      {
        ...
        __response: function (t) {
          ...
          (
            i = t &&
            t.length ? this.options.messages.results(t.length) : this.options.messages.noResults,
            this.liveRegion.children().hide(),
    ...
    e.widget(
      'ui.button',
      {
        ...
        _create: function () {
          ...
          this.buttonElement.addClass(p).attr('role', 'button').bind(
        ...
        _setOption: function (e, t) {
          ...
          'disabled' === e ? (
            ...
            (
              'checkbox' === this.type ||
              'radio' === this.type ? this.buttonElement.removeClass('ui-state-focus') : this.buttonElement.removeClass('ui-state-focus ui-state-active')
            ),
            void 0
        ...
        refresh: function () {
          ...
          'radio' === this.type ? g(this.element[0]).each(
            function () {
        ...
        _resetButton: function () {
          if ('input' === this.type) return this.options.label &&
 ...
 //         s = t.nodeName.toLowerCase(),
   //       n = 'div' === s ||
     //     'span' === s,
       //   t.id ||
   //       (this.uuid += 1, t.id = 'dp' + this.uuid),
     //     a = this._newInst(e(t), n),
       //   a.settings = e.extend({
  //        }, i || {
   //       }),
    //      'input' === s ? this._connectDatepicker(t, a) : n &&
      //    this._inlineDatepicker(t, a)
       // },
       /* _newInst: function (t, i) {
          var s = t[0].id.replace("", "");
          return {
            id: s,
            input: t,
            selectedDay: 0,
        ...
        _autoSize: function (e) {
          if (this._get(e, 'autoSize') && !e.inline) {
            ...
            (
              t = function (e) {
                for (i = 0, s = 0, n = 0; e.length > n; n++) e[n].length > i &&
                (i = e[n].length, s = n);
                return s
              },
        ...
        _dialogDatepicker: function (t, i, s, n, a) {
          ...
          i = i &&
          i.constructor === Date ? this._formatDate(c, i) : i,
        ...
        _optionDatepicker: function (t, i, s) {
          ...
          'string' == typeof i ? 'defaults' === i ? e.extend({
          }, e.datepicker._defaults) : l ? 'all' === i ? e.extend({
          }, l.settings) : this._get(l, i) : null : (
            n = i ||
            {
            },
            'string' == typeof i &&
        ...
        _doKeyDown: function (t) {
          ...
          if (a._keyEvent = !0, e.datepicker._datepickerShowing) switch (t.keyCode) {
            ...
            case 13:
              ...
              n[0] &&
              e.datepicker._selectDay(t.target, a.selectedMonth, a.selectedYear, n[0]),
              i = e.datepicker._get(a, 'onSelect'),
              i ? (
                s = e.datepicker._formatDate(a),
                i.apply(a.input ? a.input[0] : null, [
                  s,
                  a
                ])
              ) : e.datepicker._hideDatepicker(),
          ...
          t.ctrlKey ? e.datepicker._showDatepicker(this) : o = !1;
          o &&
          ...
          if (
            ...
            (
              ...
              i.dpDiv.css({
                ...
                e.blockUI ? 'static' : o ? 'fixed' : 'absolute',
                display: 'none',
                left: h.left + 'px',
                top: h.top + 'px'
              }),
              ...
              (
                ...
                e.effects &&
                e.effects.effect[l] ? i.dpDiv.show(l, e.datepicker._get(i, 'showOptions'), u) : i.dpDiv[l ||
                'show'](l ? u : null),
        ...
        _updateDatepicker: function (t) {
          ...
          n > 1 &&
          t.dpDiv.addClass('ui-datepicker-multi-' + n).css('width', a * n + 'em'),
        ...
        _checkOffset: function (t, i, s) {
          ...
          i.left -= s &&
          i.left === t.input.offset().left ? e(document).scrollLeft() : 0,
          i.top -= s &&
          i.top === t.input.offset().top + r ? e(document).scrollTop() : 0,
        ...
        _hideDatepicker: function (t) {
          ...
          (
            ...
            e.effects &&
            (e.effects.effect[i] || e.effects[i]) ? o.dpDiv.hide(i, e.datepicker._get(o, 'showOptions'), s, n) : o.dpDiv['slideDown' === i ? 'slideUp' : 'fadeIn' === i ? 'fadeOut' : 'hide'](i ? s : null, n),
            i ||
            n(),
            this._datepickerShowing = !1,
        ...
        _selectDate: function (t, i) {
          ...
          a.inline ? this._updateDatepicker(a) : (
            this._hideDatepicker(),
            this._lastInput = a.input[0],
            'object' != typeof a.input[0] &&
            a.input.focus(),
            this._lastInput = null
          )
        },
        ...
        parseDate: function (t, i, s) {
          ...
          r,
          h = 0,
          l = (s ? s.shortYearCutoff : null) ||
          this._defaults.shortYearCutoff,
          u = 'string' != typeof l ? l : (new Date).getFullYear() % 100 + parseInt(l, 10),
          d = (s ? s.dayNamesShort : null) ||
          this._defaults.dayNamesShort,
          c = (s ? s.dayNames : null) ||
          this._defaults.dayNames,
          p = (s ? s.monthNamesShort : null) ||
          this._defaults.monthNamesShort,
          f = (s ? s.monthNames : null) ||
          ...
          for (n = 0; t.length > n; n++) if (b) '\'' !== t.charAt(n) ||
          _('\'') ? k() : b = !1;
          ...
          if (
            - 1 === m ? m = (new Date).getFullYear() : 100 > m &&
            (
        ...
        formatDate: function (e, t, i) {
          if (!t) return '';
          var s,
          n = (i ? i.dayNamesShort : null) ||
          this._defaults.dayNamesShort,
          a = (i ? i.dayNames : null) ||
          this._defaults.dayNames,
          o = (i ? i.monthNamesShort : null) ||
          this._defaults.monthNamesShort,
          r = (i ? i.monthNames : null) ||
          this._defaults.monthNames,
          h = function (t) {
            var i = e.length > s + 1 &&
            e.charAt(s + 1) === t;
          ...
          d = '',
          c = !1;
          if (t) for (s = 0; e.length > s; s++) if (c) '\'' !== e.charAt(s) ||
          h('\'') ? d += e.charAt(s) : c = !1;
        ...
        _possibleChars: function (e) {
          ...
          for (t = 0; e.length > t; t++) if (s) '\'' !== e.charAt(t) ||
          n('\'') ? i += e.charAt(t) : s = !1;
        ...
        _determineDate: function (t, i, s) {
          ...
          a = function (i) {
            ...
            for (
              var n = (i.toLowerCase().match(/^c/) ? e.datepicker._getDate(t) : null) ||
              new Date,
              a = n.getFullYear(),
              o = n.getMonth(),
              r = n.getDate(),
          ...
          o = null == i ||
          '' === i ? s : 'string' == typeof i ? a(i) : 'number' == typeof i ? isNaN(i) ? s : n(i) : new Date(i.getTime());
          return o = o &&
          'Invalid Date' == '' + o ? s : o,
          o &&
          (
        ...
        _generateHTML: function (e) {
          ...
          for (
            ...
            l = B ? '<div class=\'ui-datepicker-buttonpane ui-widget-content\'>' + (Y ? h : '') + (
            ...
            for (k = '', this.maxRows = 4, T = 0; K[1] > T; T++) {
              ...
              for (
                ...
                $ &&
                z > $,
                E += '<td class=\'' + ((x + u + 6) % 7 >= 5 ? ' ui-datepicker-week-end' : '') + (j ? ' ui-datepicker-other-month' : '') + (
                  z.getTime() === D.getTime() &&
                  Z === e.selectedMonth &&
                  e._keyEvent ||
                  b.getTime() === z.getTime() &&
                  b.getTime() === D.getTime() ? ' ' + this._dayOverClass : ''
                ) + (W ? ' ' + this._unselectableClass + ' ui-state-disabled' : '') + (
                  j &&
                  !v ? '' : ' ' + O[1] + (z.getTime() === G.getTime() ? ' ' + this._currentClass : '') + (z.getTime() === R.getTime() ? ' ui-datepicker-today' : '')
                ) + '\'' + (j && !v || !O[2] ? '' : ' title=\'' + O[2].replace("", '&#39;') + '\'') + (
                  W ? '' : ' data-handler=\'selectDay\' data-event=\'click\' data-month=\'' + z.getMonth() + '\' data-year=\'' + z.getFullYear() + '\''
                ) + '>' + (
                  j &&
                  !v ? '&#xa0;' : W ? '<span class=\'ui-state-default\'>' + z.getDate() + '</span>' : '<a class=\'ui-state-default' + (z.getTime() === R.getTime() ? ' ui-state-highlight' : '') + (z.getTime() === G.getTime() ? ' ui-state-active' : '') + (j ? ' ui-priority-secondary' : '') + '\' href=\'#\'>' + z.getDate() + '</a>'
                ) + '</td>',
              ...
              M += '</tbody></table>' + (
                Q ? '</div>' + (
                  K[0] > 0 &&
                  T === K[1] - 1 ? '<div class=\'ui-datepicker-row-break\'></div>' : ''
                ) : ''
              ),
              k += M
            }
    ...
    e.fn.datepicker = function (t) {
      ...
      'widget' !== t ? 'option' === t &&
      2 === arguments.length &&
      'string' == typeof arguments[1] ? e.datepicker['_' + t + 'Datepicker'].apply(e.datepicker, [
        this[0]
      ].concat(i)) : this.each(
        function () {
    ...
    e.widget(
      'ui.dialog',
      {
        ...
        _appendTo: function () {
          var t = this.options.appendTo;
          return t &&
          (t.jquery || t.nodeType) ? e(t) : this.document.find(t || 'body').eq(0)
        },
        _destroy: function () {
          var e,
          ...
          e.length &&
          e[0] !== this.element[0] ? e.before(this.element) : t.parent.append(this.element)
        },
        widget: function () {
        ...
        _createButtons: function () {
          ...
          e.isEmptyObject(i) ||
          e.isArray(i) &&
          !i.length ? (this.uiDialog.removeClass('ui-dialog-buttons'), void 0) : (
            e.each(
              i,
              function (i, s) {
                var n,
        ...
        _setOptions: function (t) {
          ...
          e.each(
            ...
            function (e, t) {
              i._setOption(e, t),
              e in i.sizeRelatedOptions &&
              (s = !0),
              e in i.resizableRelatedOptions &&
              (n[e] = t)
            }
          ),
          s &&
    ...
    e.widget(
      'ui.progressbar',
      {
        ...
        value: function (e) {
          return void 0 === e ? this.options.value : (
    ...
    e.widget(
      'ui.selectmenu',
      {
        ...
        _move: function (e, t) {
          ...
          s = 'first' === e ||
          'last' === e ? i['first' === e ? 'prevAll' : 'nextAll'](n).eq( - 1) : i[e + 'All'](n).eq(0),
          s.length &&
    ...
    e.widget(
      ...
      e.ui.mouse,
      {
        ...
        _createRange: function () {
          ...
          t.range ? (
            ...
            (
              ...
              2 !== t.values.length ? t.values = [
                t.values[0],
                t.values[0]
              ] : e.isArray(t.values) &&
              (t.values = t.values.slice(0)) : t.values = [
                this._valueMin(),
                this._valueMin()
              ]
            ),
            this.range &&
            this.range.length ? this.range.removeClass('ui-slider-range-min ui-slider-range-max').css({
              left: '',
              bottom: ''
            }) : (
            ...
            this.range.addClass(
              i + (
                'min' === t.range ||
                'max' === t.range ? ' ui-slider-range-' + t.range : ''
              )
            )
        ...
        values: function (t, i) {
          ...
          if (!e.isArray(arguments[0])) return this.options.values &&
          this.options.values.length ? this._values(t) : this.value();
        ...
        _handleEvents: {
          keydown: function (t) {
            ...
            switch (
                a = this.options.step,
                s = n = this.options.values &&
                this.options.values.length ? this.values(o) : this.value(),
                t.keyCode
              ) {
              case e.ui.keyCode.HOME:
                n = this._valueMin();
      ...
      'ui.spinner',
      {
        ...
        _events: {
          ...
          'mouseenter .ui-spinner-button': function (t) {
            return e(t.currentTarget).hasClass('ui-state-active') ? this._start(t) === !1 ? !1 : (
              this._repeat(null, e(t.currentTarget).hasClass('ui-spinner-up') ? 1 : - 1, t),
              void 0
            ) : void 0
          },
        ...
        _start: function (e) {
          ...
          this._trigger('start', e) !== !1 ? (this.counter || (this.counter = 1), this.spinning = !0, !0) : !1
        },
        ...
        _parse: function (e) {
          ...
          (
            e = window.Globalize &&
            this.options.numberFormat ? Globalize.parseFloat(e, 10, this.options.culture) : + e
          ),
          '' === e ||
          isNaN(e) ? null : e
        },
        _format: function (e) {
          ...
          this.options.numberFormat ? Globalize.format(e, this.options.numberFormat, this.options.culture) : e
        },
        _refresh: function () {
          this.element.attr({
    ...
    e.widget(
      'ui.tabs',
      {
        ...
        _create: function () {
          ...
          this.anchors.length ? this._findActive(i.active) : e(),
          this._refresh(),
          this.active.length &&
          this.load(i.active)
        },
        ...
        _handlePageNav: function (t) {
          return t.altKey &&
          t.keyCode === e.ui.keyCode.PAGE_UP ? (
            this._activate(this._focusNextTab(this.options.active - 1, !1)),
            !0
          ) : t.altKey &&
          t.keyCode === e.ui.keyCode.PAGE_DOWN ? (
        ...
        _setOption: function (e, t) {
          return 'active' === e ? (this._activate(t), void 0) : 'disabled' === e ? (this._setupDisabled(t), void 0) : (
            this._super(e, t),
            'collapsible' === e &&
            (
        ...
        refresh: function () {
          ...
          !e.contains(this.tablist[0], this.active[0]) ? this.tabs.length === t.disabled.length ? (t.active = !1, this.active = e()) : this._activate(this._findNextTab(Math.max(0, t.active - 1), !1)) : t.active = this.tabs.index(this.active) : (t.active = !1, this.active = e()),
          this._refresh()
        },
        _refresh: function () {
          ...
          this.anchors.each(
            function (i, s) {
              ...
              t._isLocal(s) ? (
                ...
                o = h.attr('aria-controls') ||
                e({
                }).uniqueId() [0].id,
                n = '#' + o,
                a = t.element.find(n),
                a.length ||
                (a = t._createPanel(o), a.insertAfter(t.panels[i - 1] || t.tablist)),
                a.attr('aria-live', 'polite')
              ),
              a.length &&
              (t.panels = t.panels.add(a)),
              l &&
              h.data('ui-tabs-aria-controls', l),
              h.attr({
                'aria-controls': o,
                'aria-labelledby': r
              }),
        ...
        _setupDisabled: function (t) {
          e.isArray(t) &&
          (t.length ? t.length === this.anchors.length &&
          (t = !0) : t = !1);
          for (var i, s = 0; i = this.tabs[s]; s++) t === !0 ||
          - 1 !== e.inArray(s, t) ? e(i).addClass('ui-state-disabled').attr('aria-disabled', 'true') : e(i).removeClass('ui-state-disabled').removeAttr('aria-disabled');
    ...
    e.widget(
      'ui.tooltip',
      {
        ...
        _updateContent: function (e, t) {
          ...
          n = this,
          a = t ? t.type : null;
          return 'string' == typeof s ? this._open(t, e, s) : (
            i = s.call(
              e[0],
              function (i) {
                n._delay(
        ...
        _open: function (t, i, s) {
          ...
          if (s) {
            ...
            (
              t &&
              'mouseover' === t.type ? i.attr('title', '') : i.removeAttr('title')
            ),
            a = this._tooltip(i),
            o = a.tooltip,
            ...
            this.options.track &&
            t &&
            /.*/.test(t.type) ? (this._on(this.document, {
              mousemove: n
        ...
        l.prototype,
        {
          parse: function (n, o, r, h) {
            ...
            'string' === c ? this.parse(s(n) || a._default) : 'array' === c ? (f(u.rgba.props, function (e, t) {
              ...
              n instanceof l ? f(u, function (e, t) {
                n[t.cache] &&
                (d[t.cache] = n[t.cache].slice())
              }) : f(
                u,
                function (t, s) {
                  var a = s.cache;
        ...
        f(
          ...
          function (t, i) {
            ...
            e.fx.step[i] = function (t) {
              t.colorInit ||
              (t.start = l(t.elem, i), t.end = l(t.end), t.colorInit = !0),
    ...
    function () {
      function t(t) {
        ...
        'string' == typeof n[i] &&
        (a[e.camelCase(i)] = n[i]);
         else for (i in n) 'string' == typeof n[i] &&
        (a[i] = n[i]);
        return a
      }
      function i(t, i) {
      ...
      e.fn.extend({
        ...
        toggleClass: function (t) {
          return function (i, s, n, a, o) {
            ...
            void 0 === s ? n ? e.effects.animateClass.call(this, s ? {
              add: i
            }
             : {
              remove: i
    ...
    function () {
      ...
      function i(t) {
        return !t ||
        'number' == typeof t ||
        e.fx.speeds[t] ? !0 : 'string' != typeof t ||
        e.effects.effect[t] ? e.isFunction(t) ? !0 : 'object' != typeof t ||
        t.effect ? !1 : !0 : !0
      }
      e.extend(
        e.effects,
        {
          version: '1.11.4',
          save: function (e, t) {
            for (var i = 0; t.length > i; i++) null !== t[i] &&
            e.data(y + t[i], e[0].style[t[i]])
          },
          restore: function (e, t) {
            var i,
            s;
            for (s = 0; t.length > s; s++) null !== t[s] &&
      ...
      e.fn.extend({
        effect: function () {
          ...
          return e.fx.off ||
          !o ? n ? this[n](s.duration, s.complete) : this.each(function () {
            s.complete &&
    ...
    function () {
      ...
      e.extend(
        t,
        {
          ...
          Elastic: function (e) {
            return 0 === e ||
            1 === e ? e : - Math.pow(2, 8 * (e - 1)) * Math.sin((80 * (e - 1) - 7.5) * Math.PI / 15)
          },
          Back: function (e) {
            return e * e * (3 * e - 2)
          },
    ...
    e.effects.effect.blind = function (t, i) {
      ...
      n = s[p](),
      a = parseFloat(s.css(f)) ||
      0,
      g[p] = v ? n : 0,
      m ||
      (
        o.css(c ? 'bottom' : 'right', 0).css(c ? 'top' : 'left', 'auto').css({
          position: 'absolute'
        }),
        g[f] = v ? a : n + a
      ),
      v &&
      (s.css(p, 0), m || s.css(f, a + n)),
      s.animate(
        g,
        {
          duration: t.duration,
    ...
    e.effects.effect.bounce = function (t, i) {
      ...
      for (
        ...
        c ||
        (c = o['top' === v ? 'outerHeight' : 'outerWidth']() / 3),
        u &&
        (
          a = {
            opacity: 1
    ...
    e.effects.effect.drop = function (t, i) {
      ...
      r &&
      n.css('opacity', 0).css(l, 'pos' === u ? - s : s),
      d[l] = (r ? 'pos' === u ? '+=' : '-=' : 'pos' === u ? '-=' : '+=') + s,
      n.animate(
        d,
        {
    ...
    e.effects.effect.fold = function (t, i) {
      ...
      g[f[0]] = h ? n[0] : u,
      v[f[1]] = h ? n[1] : 0,
      s.animate(g, m, t.easing).animate(
        v,
        m,
        t.easing,
        function () {
    ...
    e.effects.effect.size = function (t, i) {
      ...
      'toggle' === t.mode &&
      'show' === p ? (o.from = t.to || b, o.to = t.from || s) : (o.from = t.from || ('show' === p ? b : s), o.to = t.to || ('hide' === p ? b : s)),
      a = {
        from: {
      ...
      ('content' === m || 'both' === m) &&
      (
        d = d.concat(['marginTop',
        'marginBottom']).concat(u),
        c = c.concat(['marginLeft',
        'marginRight']),
    ...
    e.effects.effect.shake = function (t, i) {
      ...
      n.animate(m, d, t.easing).animate(f, d / 2, t.easing).queue(
        function () {
          'hide' === o &&
          n.hide(),
          e.effects.restore(n, a),
